class VerseInteractions {
    constructor() {
        ...
        console.log('VerseInteractions inicializado - Versão 2.1');
    }
    ...
    initializeShareButtons() {
        document.querySelectorAll('.share-verse').forEach(button => {
            button.addEventListener('click', async (e) => {
                ...
                // Texto para compartilhar (mais curto que o de cópia)
                const textToShare = `${reference}\n\n${portuguese}\n\nEvangelhos Aramaico Siríaco`;
                ...
                try {
                    ...
                    if (navigator.share) {
                        ...
                        this.showCopyFeedback(button, 'bi-check-lg', 'Texto copiado!');
                    }
                } catch (err) {
